...
class Product(db.Model):
    ...
    #data_criacao = db.Column(db.DateTime(6),  nullable=False)
    date_created = db.Column(db.DateTime(8), default=db.func.current_timestamp(), nullable=False)
    # last_update = db.Column(db.DateTime(6), onupdate=db.func.current_timestamp(), nullable=False)
    obrigatorio = db.Column(db.Boolean, default=1, nullable=False)
